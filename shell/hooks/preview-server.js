...
// Server-runtime preview driver: the route-backed iframe rendered by the host.
// The iframe node is owned by the server HTML; this driver only reloads its
// content and toggles visibility, never recreates it.
