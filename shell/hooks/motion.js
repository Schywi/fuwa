	...
	*/
	...
	var mermaidDefinitions = {
		...
		backend: joinDiagram([
			...
			'    direction LR',
			'    DevServer["dev-server.py"]:::python',
			'    CL["container-logs.py"]:::python',
			'  end',
			'  subgraph LuaCGI["Lua CGI"]',
		...
		infra: joinDiagram([
			...
			'  %% bridge => infra/docker-compose/otlp-bridge.py',
			...
			'  service bridge(server)[OTLP bridge] in telemetry',
