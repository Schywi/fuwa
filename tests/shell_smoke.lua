...
assert_true(html:find('src="/payload/current/"', 1, true) ~= nil, "shell should mount the current payload route")
...
assert_true(html:find("sandbox=\"allow-scripts allow-forms allow-same-origin\"", 1, true) ~= nil, "shell should sandbox the mounted payload")
