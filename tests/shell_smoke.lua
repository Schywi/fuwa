...
assert_true(workspace_fuwa:find("expandedTraceId === request.traceId", 1, true) ~= nil, "observability should expand rows inline")
...
assert_true(html:find("Browser runtime", 1, true) ~= nil, "shell should render the browser badge")
assert_true(html:find("In-memory live session", 1, true) ~= nil, "shell should render the browser runtime footnote")
