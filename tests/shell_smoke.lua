...
local preview_server_js = files["hooks/preview-server.js"]
...
assert_true(browser_index_js:find("window.FuwaShellObservability", 1, true) == nil, "browser entrypoint should not expose an observability global")
assert_true(browser_index_js:find("import '../observability.js';", 1, true) ~= nil, "browser entrypoint should load observability as a side-effect module")
...
assert_true(browser_index_js:find("window.FuwaShellCursor", 1, true) == nil, "browser entrypoint should not expose a cursor global")
assert_true(browser_index_js:find("window.FuwaShellTmux", 1, true) == nil, "browser entrypoint should not expose a tmux global")
assert_true(browser_index_js:find("window.FuwaRuntimeSession", 1, true) == nil, "browser entrypoint should not expose a runtime session global")
assert_true(browser_index_js:find("window.FuwaPreviewBrowserDriver", 1, true) == nil, "browser entrypoint should not expose a preview-browser global")
assert_true(browser_index_js:find("window.FuwaShellEditor", 1, true) == nil, "browser entrypoint should not expose an editor global")
assert_true(browser_index_js:find("window.FuwaShellTerminal", 1, true) == nil, "browser entrypoint should not expose a terminal global")
assert_true(browser_index_js:find("window.FuwaShellWorkspace", 1, true) == nil, "browser entrypoint should not expose a workspace global")
assert_true(browser_index_js:find("window.FuwaShellMotion", 1, true) == nil, "browser entrypoint should not expose a motion global")
assert_true(browser_index_js:find("window.FuwaShellPreview", 1, true) == nil, "browser entrypoint should not expose a preview global")
assert_true(browser_index_js:find("import '../editor.js';", 1, true) ~= nil, "browser entrypoint should load the editor module")
assert_true(browser_index_js:find("import '../terminal.js';", 1, true) ~= nil, "browser entrypoint should load the terminal module")
assert_true(browser_index_js:find("import '../workspace.js';", 1, true) ~= nil, "browser entrypoint should load the workspace module")
assert_true(browser_index_js:find("import '../preview.js';", 1, true) ~= nil, "browser entrypoint should load the preview module")
assert_true(preview_server_js:find("window.FuwaPreviewServerDriver", 1, true) == nil, "preview server driver should not assign a global")
assert_true(preview_server_js:find("export function create(context)", 1, true) ~= nil, "preview server driver should expose an ESM factory")
...
assert_true(home_fuwa:find('v-scope="workspace"', 1, true) ~= nil, "shell should mount petite-vue on the stable shell parent")
...
assert_true(html:find('v%-scope="workspace"', 1) ~= nil, "shell should mount petite-vue workspace state")
