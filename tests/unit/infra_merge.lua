...
t.test("shell tmux pane points at the real app container", function()
	...
	t.contains(home, "toggleGrafana('/dash/signoz', 'SigNoz dashboard')", "expected SigNoz button to drive the embedded dashboard panel")
	t.contains(home, "toggleGrafana('/dash/uptrace/', 'Uptrace dashboard')", "expected Uptrace button to reuse the embedded dashboard panel")
