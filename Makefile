...
UNIT_TESTS       = tests/unit/compiler.lua tests/unit/browser.lua tests/unit/db.lua tests/unit/host.lua tests/unit/trace.lua tests/unit/architecture_panel.lua
